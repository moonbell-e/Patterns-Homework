...
public class CharacterView : MonoBehaviour
{
    ...
    public void StartWalking() => Debug.Log("Start Walking");
    public void StopWalking() => Debug.Log("Stop Walking");
    public void StartFastRunning() => Debug.Log("Start Fast Running");
    public void StopFastRunning() => Debug.Log("Start Fast Running");
}